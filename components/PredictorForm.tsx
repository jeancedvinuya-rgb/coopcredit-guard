      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input type="number" name="age" value={formData.age} onChange={handleChange} min={18} className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none ${ageError ? 'border-red-500' : ''}`} required />
